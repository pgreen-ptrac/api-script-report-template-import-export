...
def request_import_report_template(base_url, headers, tenant_id, payload):
...
def request_export_report_template(base_url, headers, tenant_id, payload):
...
def request_get_report_template(base_url, headers, tenant_id, report_template_id):
